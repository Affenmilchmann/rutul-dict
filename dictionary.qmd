...
mutate(data, 
  ...
  select(href, No.stress, Orthography, meanings_rus, meanings, Part.of.Speech, comment_to_appear) %>% 
  datatable(filter = 'top', escape = FALSE, rownames = FALSE,
            colnames = c("Glossing Label", "Lexical entry", "Orthography", "Russian", "English", "Part of Speech", "Comment"),
